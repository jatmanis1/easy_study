"""
Django settings for easy_study project.
...
SECRET_KEY = 'django-insecure-j-pns$mfj!=_x)789)^*#te6n$a154w@8q7hp&2jsu&n+@f=$u'
...
WSGI_APPLICATION = 'easy_study.wsgi.application'
